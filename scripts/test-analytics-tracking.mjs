...
for (const eventName of ['content_view', 'scroll_depth', 'qualified_read', 'view_item', 'comparison_complete', 'store_click', 'internal_link_click', 'external_link_click', 'button_click', 'race_calendar_view', 'race_detail_open', 'race_outbound_click']) {
