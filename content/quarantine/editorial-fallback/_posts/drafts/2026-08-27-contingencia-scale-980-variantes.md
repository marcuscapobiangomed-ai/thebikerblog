...
layout: post
published: false
title: "Scott Scale 980: método para distinguir variantes, cores e montagens sem misturar fichas"
slug: "scott-scale-980-metodo-para-distinguir-variantes-cores-e-montagens-sem-misturar-fichas"
date: 2026-08-20
...
description: "Leitura documental de Scott Scale 980: método para distinguir variantes, cores e montagens sem misturar fichas, organizada por registros oficiais, limites e lacunas que precisam permanecer visiveis."
...
sources:
  ...
  - name: "TheBiker — Bicicleta Scott Scale 980 Blue"
    type: "store"
    url: "https://thebikershop.com.br/produtos/bicicleta-scott-scale-980-blue/"
    accessed_at: "2026-08-04"
---
...
Este comparativo parte de duas identificacoes documentais: <a href="https://thebikershop.com.br/produtos/bicicleta-scott-scale-980-black/" class="thebiker-product-link" target="_blank" rel="noopener">Bicicleta Scott Scale 980 Black</a> e <a href="https://thebikershop.com.br/produtos/bicicleta-scott-scale-980-blue/" class="thebiker-product-link" target="_blank" rel="noopener">Bicicleta Scott Scale 980 Blue</a>. A pesquisa nao trata a leitura como teste de campo; cada afirmacao permanece ligada ao registro recuperado e ao limite declarado pela fonte.
...
A primeira ficha nomeia Bicicleta Scott Scale 980 Black; a segunda registra Bicicleta Scott Scale 980 Blue. Essa separacao e importante porque nomes comerciais parecidos podem reunir montagens diferentes, e o artigo so usa a descricao associada a cada fonte.
...
A parte de suspensao aparece na fonte como Suntour X1 32 RL-R. A frase e mantida em seu contexto para diferenciar modelo, curso, sistema e componente, sem inferir sensacoes ou desempenho a partir de uma unica linha.
...
Na transmissao, a base recuperada e: Shimano Deore RD-M6100. O dado entra na comparacao como identificacao de montagem e nao como classificacao automatica de troca, durabilidade ou faixa de uso.
...
Freios, rodas e <a href="https://thebikershop.com.br/componentes/pneus-para-ciclismo/" class="thebiker-product-link" target="_blank" rel="noopener">pneus</a> aparecem nos registros como Shimano MT200. O texto organiza esses dados para leitura lado a lado, sem usar o nome do componente como atalho para potencia, aderencia ou seguranca.
...
Alguns campos se repetem entre os produtos; outros aparecem somente uma vez. O registro de referencia para esta leitura e Bicicleta Scott Scale 980 Black, e ele serve para demonstrar como o artigo distingue dado comum de campo exclusivo.
...
As diferencas confirmadas sao apresentadas por campo, nao por adjetivo. Neste conjunto, a pesquisa tambem registra https://thebikershop.com.br/produtos/bicicleta-scott-scale-980-black/, enquanto os demais pontos dependem das linhas tecnicas ja descritas nas secoes anteriores.
...
- **TheBiker — Bicicleta Scott Scale 980 Blue** (store) — https://thebikershop.com.br/produtos/bicicleta-scott-scale-980-blue/ — acessado em 2026-08-04
