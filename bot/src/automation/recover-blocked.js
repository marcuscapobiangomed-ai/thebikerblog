...
const RECOVERY_RESERVES = [
  { id: 'reserva-checklist-montagem-cockpit', title: 'Checklist de montagem do cockpit: fita, comandos e torque', summary: 'Checklist documental para conferir fita, alinhamento dos comandos e torque do cockpit antes do primeiro pedal, sem inventar medidas ausentes.', category: 'manutencao-ajustes', productIds: ['fita-de-guidao-supacaz-super-sticky-preta'], heroImage: { mode: 'real-context', productId: 'fita-de-guidao-supacaz-super-sticky-preta', relationship: 'category-example', rationale: 'Fotografia real de uma fita de guidão usada apenas como exemplo visual de uma montagem de cockpit.' } },
