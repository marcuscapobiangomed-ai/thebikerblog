...
export function buildUserPrompt({ topic, researchData, contentType, template, today }) {
  ...
  return [
    ...
    '  "title": "Título claro com no máximo 70 caracteres",',
    '  "description": "Meta descrição completa entre 140 e 160 caracteres, terminada por pontuação",',
    '  "direct_answer": "Resposta factual e autossuficiente entre 80 e 420 caracteres, diferente da meta descrição e sem linguagem promocional",',
